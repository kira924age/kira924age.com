  ...
  return (
    <Layout>
      ...
      <ul>
        ...
        <li key="16">とある科学の超電磁砲 (Toaru Kagaku no Railgun)</li>
        <li key="17">さくら荘のペットな彼女 (The Pet Girl of Sakurasou)</li>
        <li key="18">恋する小惑星 (Koisuru Asteroid)</li>
        <li key="19">うたわれるもの (Utawarerumono)</li>
        <li key="20">
