...
export const FAVORITE_ANIME_LIST: Anime[] = [
  ...
  { id: 48542, name: "Do It Yourself!! -どぅー・いっと・ゆあせるふ- (Do It Yourself!! -Dou Itto Yuaserufu-)" },
  ...
  { id: 2661, name: "ドラえもん のび太と雲の王国 (Doraemon Movie 13: Nobita to Kumo no Oukoku)" },
  { id: 2450, name: "クレヨンしんちゃん 嵐を呼ぶ モーレツ!オトナ帝国の逆襲 (Eiga Crayon Shin-chan: Arashi wo Yobu Mouretsu! Otona Teikoku Gyakushuu)" },
  { id: 8360, name: "クレヨンしんちゃん 電撃!ブタのヒヅメ大作戦 (Eiga Crayon Shin-chan: Dengeki! Buta no Hizume Daisakusen)" },
  ...
  { id: 10357, name: "人類は衰退しました (Jinrui wa Suitai Shimashita Specials)" },
  ...
  { id: 9989, name: "あの日見た花の名前を僕達はまだ知らない。 (Ano Hi Mita Hana no Namae wo Bokutachi wa Mada Shiranai.)" },
  { id: 31953, name: "NEW GAME!" },
  { id: 1689, name: "秒速5センチメートル (5 Centimeters per Second a chain of short stories about their distance)" },
  ...
  { id: 22189, name: "普通の女子校生が【ろこどる】やってみた。 (Futsuu no Joshikousei ga [Locodol] Yattemita.)" },
